...
export class SearchComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.categories$ = this.store.select(SearchSelectors.getRecommendedCategories)
    ...
    getTopicColors() {
        ...
        scheme.from_hue(20).scheme('triade').variation('default')
        return scheme.colors()
    }
    getCategoryColors() {
        var scheme = new ColorScheme()
        scheme.from_hue(50).scheme('tetrade').variation('pastel')
        return scheme.colors()
    }
}
